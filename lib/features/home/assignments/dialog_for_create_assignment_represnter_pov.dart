...
void showDialogForCreateAssignmentRepresnterPov({
  ...
  required int groupId, // ✅ groupId ثابت
  required List<Map<String, dynamic>> subjects, // ✅ المواد من الخارج
    ...
    builder: (context) {
      return StatefulBuilder(
        builder: (context, setState) {
          void onSubjectChanged(String? newSubjectName) {
            if (newSubjectName == null) return;

            setState(() {
              selectedSubjectName = newSubjectName;
              selectedSubjectId = subjects.firstWhere((sub) => sub['name'] == newSubjectName)['id'];
            });
          }
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        onTap: () async {
                          ...
                          if (date != null) {
                            dueDateController.text = date.toIso8601String().split('T').first;
                          }
                        },
                        validator: (value) =>
                            value == null || value.isEmpty ? 'تاريخ التسليم مطلوب' : null,
                      ),
                      SizedBox(height: 10),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        validator: (value) =>
                            value == null || value.isEmpty ? 'المادة مطلوبة' : null,
                      ),
                    ],
                  ),
                ),
