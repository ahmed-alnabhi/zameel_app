                                ...
                                if (result['success']) {
                                 ...
                                 showDialog(
                                    ...
                                    builder: (context) => Directionality(
                                      textDirection: TextDirection.rtl,
                                      child: AlertDialog(
                                        title:  Text(' تم إرسال الطلب بنجاح' , style: TextStyle(fontSize: 18 , color: Theme.of(context).colorScheme.onPrimary , fontFamily: AppFonts.mainFontName)
                                          ),
                                          
                                        content:  Text(
                                            'سيتم تحويلكم الى التطبيق لكن  لن تستطيعوا الوصول الى بيانات الدفعة حتى يتم الموافقة عليكم' , style: TextStyle(fontSize: 14 , color: Theme.of(context).colorScheme.onPrimary ,height: 1.9 , fontFamily: AppFonts.mainFontName)) ,
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                            ...
                                            child:  Text('حسنا' , style: TextStyle(fontSize: 14 , color: Theme.of(context).colorScheme.primary , fontFamily: AppFonts.mainFontName)), 
                                          ),
                                        ],
                                      ),
                                    )
                                  );
                                  print("✅ الطلب تم إرساله بنجاح");
